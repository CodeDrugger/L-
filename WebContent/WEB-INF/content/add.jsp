    ...
    <td align="center">
      <form action="postadd" method="get">
        <table class="utb" align="center" width="700" border="0">
          <tr>
            <td>ISBN:</td>
            <td><input class="text" id="i1" type="text" name="book.isbn"></td></tr>
          <tr>
            <td>Title:</td>
            <td><input class="text" id="i2" type="text" name="book.title"></td></tr>
          <tr>
            <td>AuthorID:</td>
            <td><input class="text" id="i3" type="text" name="book.authorid"></td></tr>
          <tr>
            <td>Publisher:</td>
            <td><input class="text" id="i4" type="text" name="book.publisher"></td></tr>
          <tr>
            <td>PublishDate:</td>
            <td><input class="text" id="i5" type="text" name="book.publishdate"></td></tr>
          <tr>
            <td>Price:</td>
            <td><input class="text" id="i6" type="text" name="book.price"></td></tr>
            <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td></tr>
          <tr>
